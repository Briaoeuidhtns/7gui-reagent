...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15843){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15844,G__15845,seq15843__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15869_SHARP_){
return (!((cljs.core.meta(p1__15869_SHARP_) == null)));
})))){
...
var map__15873 = opts;
var map__15873__$1 = (((((!((map__15873 == null))))?(((((map__15873.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15873.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15873):map__15873);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15873__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15880){var _e__13013__auto__ = e15880;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e15887){var _e__13013__auto__ = e15887;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__15908 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15909 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15909);

try{var map__15910 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15910__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15908);
}});
...
var temp__5733__auto___15950 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___15950)){
var managed_print_level_15951 = temp__5733__auto___15950;
var _STAR_print_level_STAR__orig_val__15920_15952 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__15921_15953 = managed_print_level_15951;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__15921_15953);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__15919_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__15919_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__15920_15952);
}} else {
job_fn();
}
