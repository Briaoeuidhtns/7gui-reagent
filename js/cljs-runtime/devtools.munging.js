...
var o15697 = temp__5733__auto__;
var temp__5733__auto____$1 = (o15697["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o15698 = temp__5733__auto____$1;
return (o15698["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12987__auto__ = f;
return (o__12987__auto__["toString"]).call(o__12987__auto__);
} else {
return "";
}
...
try{var o__12987__auto___15778 = t;
(o__12987__auto___15778["cljs$lang$ctorPrWriter"]).call(o__12987__auto___15778,t,writer);
}catch (e15700){var __15779 = e15700;
}
...
var char_code = (function (){var o__12987__auto__ = (new String(char$));
return (o__12987__auto__["charCodeAt"]).call(o__12987__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12987__auto__ = String;
return (o__12987__auto__["fromCharCode"]).call(o__12987__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15701 = num_code;
switch (G__15701) {
case (1):
return (185);
...
var o__12987__auto__ = String;
return (o__12987__auto__["fromCharCode"]).call(o__12987__auto__,superscript_code);
});
/**
...
}catch (e15702){var _e__13013__auto__ = e15702;
return false;
}})())){
...
var vec__15703 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15703,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15708){
var vec__15709 = p__15708;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15709,(0),null);
...
var G__15784 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__15785 = cljs.core.butlast(remaining_tokens);
name_tokens = G__15784;
remaining_tokens = G__15785;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15706){
...
var vec__15714 = cljs.core.split_with((function (p1__15713_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__15713_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15714,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15714,(1),null);
...
var vec__15720 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15720,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15720,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__15787 = cljs.core.rest(remaining_tokens);
var G__15788 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__15787;
name_tokens = G__15788;
continue;
} else {
...
var vec__15725 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15725,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15725,(1),null);
var vec__15728 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15728,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15728,(1),null);
var vec__15731 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15731,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15731,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15731,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15731,(3),null);
...
var vec__15736 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15736,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__15739 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15739,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15739,(1),null);
var vec__15742 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15742,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__15745 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__15745) : devtools.munging.parse_fn_info_deep.call(null,G__15745));
})()));
}
} else {
return fn_info;
...
var G__15791 = (arity + (1));
var G__15792 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15746){
var vec__15747 = p__15746;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15747,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15750_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__15750_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15751_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__15751_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15754){
var vec__15755 = p__15754;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15755,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15752){
...
var map__15759 = options;
var map__15759__$1 = (((((!((map__15759 == null))))?(((((map__15759.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15759.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15759):map__15759);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15759__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15759__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15759__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15759__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15760 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15760,(5),null);
...
var o__12987__auto__ = f;
return (o__12987__auto__["getBasis"]).call(o__12987__auto__);
});
/**
...
}catch (e15764){var _e__13013__auto__ = e15764;
...
var G__15797 = (obj[cljs.core.first(path)]);
var G__15798 = cljs.core.rest(path);
obj = G__15797;
path = G__15798;
continue;
} else {
...
var _STAR_ = (function (accum,p__15765){
var vec__15766 = p__15765;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15766,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15766,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15769){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15770,(2),null);
...
var post_process = (function (p__15774){
var vec__15775 = p__15774;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15775,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15775,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15773_SHARP_){
return (obj[cljs.core.first(p1__15773_SHARP_)]);
}),sorted_matches);
