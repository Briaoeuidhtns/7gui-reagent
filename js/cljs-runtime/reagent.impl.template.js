...
var G__16672 = o;
goog.object.set(G__16672,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__16690__delegate = function (args){
...
while (G__16691__i < G__16691__a.length) {G__16691__a[G__16691__i] = arguments[G__16691__i + 0]; ++G__16691__i;}
  args = new cljs.core.IndexedSeq(G__16691__a,0,null);
} 
...
var args = cljs.core.seq(arglist__16692);
...
var G__16673 = o;
goog.object.set(G__16673,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__16695__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__16696__i < G__16696__a.length) {G__16696__a[G__16696__i] = arguments[G__16696__i + 0]; ++G__16696__i;}
  args = new cljs.core.IndexedSeq(G__16696__a,0,null);
} 
...
var args = cljs.core.seq(arglist__16697);
...
var G__16674 = props;
var G__16674__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16674,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16674);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16674__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__16675 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16675,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__16675;
}
})(),id_class);
...
var G__16676 = (cljs.core.count(argv) - first_child);
switch (G__16676) {
case (0):
...
var vec__16677 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16677,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16677,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16677,(2),null);
...
var temp__5739__auto___16708 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___16708 == null)){
} else {
var key_16709 = temp__5739__auto___16708;
(jsprops.key = key_16709);
}
...
var temp__5739__auto___16710 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___16710 == null)){
} else {
var key_16711 = temp__5739__auto___16710;
(jsprops.key = key_16711);
}
...
var temp__5739__auto___16712 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___16712 == null)){
} else {
var key_16713 = temp__5739__auto___16712;
(jsprops.key = key_16713);
}
...
var temp__5739__auto___16714 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___16714 == null)){
} else {
var key_16715 = temp__5739__auto___16714;
(jsprops.key = key_16715);
}
...
var temp__5739__auto___16716 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___16716 == null)){
} else {
var key_16717 = temp__5739__auto___16716;
(jsprops.key = key_16717);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16680_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__16680_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__16681 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16681,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16681,(1),null);
...
break;
default:
var G__16723 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__16724 = compiler;
v = G__16723;
compiler = G__16724;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template16687 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template16687 = (function (opts,id,fn_to_element,meta16688){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template16687.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16689,meta16688__$1){
var self__ = this;
var _16689__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template16687(self__.opts,self__.id,self__.fn_to_element,meta16688__$1));
}));

(reagent.impl.template.t_reagent$impl$template16687.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16689){
var self__ = this;
var _16689__$1 = this;
return self__.meta16688;
}));

(reagent.impl.template.t_reagent$impl$template16687.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template16687.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template16687.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template16687.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template16687.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta16688","meta16688",-1108060049,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template16687.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template16687.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template16687");

(reagent.impl.template.t_reagent$impl$template16687.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template16687");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template16687.
 */
reagent.impl.template.__GT_t_reagent$impl$template16687 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template16687(opts__$1,id__$1,fn_to_element__$1,meta16688){
return (new reagent.impl.template.t_reagent$impl$template16687(opts__$1,id__$1,fn_to_element__$1,meta16688));
});

}

return (new reagent.impl.template.t_reagent$impl$template16687(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
